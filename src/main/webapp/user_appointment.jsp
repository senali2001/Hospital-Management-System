        ...
        <div class="row">
            ...
            <div class="coL-md-6">
               <div class="card paint-card">
                  <div class="card-body">
                    <p class="text-center fs-3">User Appoinment</p>
                    ...
                    <form class="row g-3" action="add_appoint" method="post">
                       ...
                       <input type="hidden" name="appAppointment" value="${userobj.id}">
                       ...
                       <div class="col-md-6">
                          <label for="inputEmail4" class="form-label">Appoinment Date</label> <input type="date" class="form-control" required name="appoint_date">
                       </div>
                       ...
                       <div class="col-md-6">
                          <label for="inputEmail4" class="form-label">Doctor</label> <select required class="form-control" name="doct">
